...
class NarutoCharacter(Character):
  ...
  def start(self):
    ...
    self.nomal_attack_spritesheet = [[self.handle_image(pygame.image.load(GameConstants.NARUTO_ATTACK1_SPRITESHEET_SOURCE[0]).convert_alpha(),56,48,4,GameConstants.NARUTO_ATTACK1_SPRITESHEET_SOURCE[1]),GameConstants.NARUTO_ATTACK1_SPRITESHEET_SOURCE[1],GameConstants.NARUTO_ATTACK1_SPRITESHEET_SOURCE[2],GameConstants.NARUTO_ATTACK1_SPRITESHEET_SOURCE[3],GameConstants.NARUTO_ATTACK1_SPRITESHEET_SOURCE[4]]]
