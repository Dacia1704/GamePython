...
class NarutoNomalAttack2State(NomalAttackState):
  ...
  def enter(self):
    ...
    self.attack_collider_animations = GameConstants.NARUTO_ATTACK2_COLLIDER_ANIMATIONS
  def exit(self):
  ...
  def draw(self, surface):
    super().draw(surface)
    self.draw_attack_animation(surface,self.state_machine.character.nomal_attack2_spritesheet,GameConstants.NARUTO_ATTACK2_COLLIDER_DICTIONARY)
