...
class NarutoNomalAttack1State(NomalAttackState):
  ...
  def update(self):
    super().update()
    self.update_sprite_animation(self.state_machine.character.nomal_attack1_spritesheet[0],self.state_machine.character.nomal_attack1_spritesheet[2],False)
  ...
  def draw(self, surface):
    nomal_attack_sprite_sheet = self.state_machine.character.nomal_attack1_spritesheet
