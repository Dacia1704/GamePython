...
class GameConstants:
  ...
  ROCKLEE_SKILL1_SPRITESHEET_SOURCE = ["Assets/Characters/RockLee/skill1.png",3,70,7,25,20]  
  ROCKLEE_SKILL1_COLLIDER_ANIMATIONS = [2,3,4]
  ROCKLEE_SKILL1_COLLIDER_DICTIONARY = {
    2:[[-ROCKLEE_WIDTH_RECT/2 + 30,-ROCKLEE_HEIGHT_RECT/2 - 20],[60,40]],
    3:[[-ROCKLEE_WIDTH_RECT/2 + 30,-ROCKLEE_HEIGHT_RECT/2 - 70],[60,40]],
    4:[[-ROCKLEE_WIDTH_RECT/2 + 30,-ROCKLEE_HEIGHT_RECT/2 - 80],[60,40]]
  }
  ROCKLEE_SKILL2_SPRITESHEET_SOURCE = ["Assets/Characters/RockLee/tele.png",3,70,50,30,10]  
  ROCKLEE_SKILL2_COLLIDER_ANIMATIONS = []
