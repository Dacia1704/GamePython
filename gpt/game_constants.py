...
class GameConstants:
  ...
  NARUTO_SKILL3_SPRITESHEET_SOURCE = ["Assets/Characters/Sasuke/skill3.png",3,1000,13,50,5]  
  NARUTO_SKILL3_COLLIDER_ANIMATIONS = []
  NARUTO_SKILL3_COLLIDER_DICTIONARY = {
  }
  NARUTO_ENERGY_BALL_SPRITESHEET_SOURCE = ["Assets/Characters/Sasuke/thunder.png",1.5,30,10,10,10] 
